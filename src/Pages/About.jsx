...
const ProfileImage = memo(() => (
  <div className="flex justify-end items-center sm:p-12 sm:py-0 sm:pb-0 p-0 py-2 pb-2">
    ...
    >
      {/* Fundos gradientes otimizados com complexidade reduzida para mobile */}
      ...
      <div className="relative">
        <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105">
          ...
          {/* Efeitos de sobreposição otimizados - desativados no mobile */}
          ...
          {/* Efeitos hover avançados - apenas desktop */}
...
const AboutPage = () => {
  ...
  useEffect(() => {
    ...
    // Handler de redimensionamento com debounce
    let resizeTimer;
    const handleResize = () => {
  ...
  // Dados de estatísticas memoizados
